class Nglib < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/bblacey/formula-patches/nglib-occt7-patches/nglib/define-PI-and-avoid-tcl-install.diff"
  ...
  if build.with? "opencascade"
    patch do
      url "https://raw.githubusercontent.com/bblacey/formula-patches/nglib-occt7-patches/nglib/occt7.x-compatibility-patches.diff"
